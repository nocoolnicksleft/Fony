...
extern void InitLcd(void);
extern void LCDWriteBitmap(int x, int y, int width, int height, unsigned char * data);
...
extern void LCDPutString (char *lcd_string, const char *font_style, unsigned char x, unsigned char y,unsigned char fcolor, unsigned char bcolor);
